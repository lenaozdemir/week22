...
class SuperheroesList extends React.Component {
    render() {
        ...
        // Создаем массив компонентов Herocard на основе данных из массива superheroesData
        const superheroCards = superheroesData.map((superhero, index) => (
            <Herocard
                key={index}
                name={superhero.name}
